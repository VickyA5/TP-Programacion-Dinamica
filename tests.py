...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--tests-autogenerated",
        action="store_true",
        help="Use autogenerated tests instead of catedra.",
    )
    ...
    if args.tests_autogenerated:
        sorted_files = sorted(os.listdir("test_cases/autogenerated"), key=lambda x: int(x.split('.')[0]))
        for file in sorted_files:
            file_path = os.path.join("test_cases/autogenerated", file)
            print(f"File: {file}")
            tests(
                file_path,
                implementation,
